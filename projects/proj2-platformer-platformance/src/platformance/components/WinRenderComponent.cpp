...
WinRenderComponent::WinRenderComponent(GameObject & gameObject, const std::string &fontResPath, Level* level):
...
void
WinRenderComponent::render(SDL_Renderer * renderer) const
{
    char scoreBuffer[15];
